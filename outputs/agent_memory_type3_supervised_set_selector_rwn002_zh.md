...
当前 redundancy weight 为 `-0.02`。训练和测试仍使用 query-level held-out split，避免同一 query 的候选泄漏。
...
| supervised_set_selector | 5 | 25.2 | 0.389 | 0.312 | 0.393 | 0.481 |
...
| supervised_set_selector | 126 | 2.65 | 0.675 | 0.476 | 0.175 | 0.317 |
| candidate_oracle | 126 | 2.65 | 0.675 | 0.778 | 0.524 | 0.658 |

## 相比 Type-Aware 的变化

- MRR delta：`-0.0449`
- Recall@5 delta：`-0.0657`
- Coverage@5 delta：`-0.0604`
- Full@5 delta：`-0.0556`
