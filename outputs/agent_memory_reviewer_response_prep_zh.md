...
| 结果是否可复现，artifact 是否完整？ | low | reproducibility artifacts=186/186, metrics=22/22, integrity ok/skip=186/186。 | 新增 artifact 后必须同步刷新清单和 manifest。 | 随论文提交附复现命令、artifact index 和 sha256 manifest。 |
