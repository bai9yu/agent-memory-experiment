...
| Type 3 多证据问题是否真的被解决？ | medium | Type 3 supervised set selector Coverage@5 delta=-0.0572, 95% CI=[-0.1106, -0.0062]，当前是负结果。 | 需要 listwise/setwise objective 或 LLM query decomposition，当前方法没有解决 Type 3。 | 把 Type 3 写成清晰边界和未来工作，不把它包装成主贡献。 |
| 结果是否可复现，artifact 是否完整？ | low | reproducibility artifacts=125/125, metrics=13/13, integrity ok/skip=125/125。 | 新增 artifact 后必须同步刷新清单和 manifest。 | 随论文提交附复现命令、artifact index 和 sha256 manifest。 |
