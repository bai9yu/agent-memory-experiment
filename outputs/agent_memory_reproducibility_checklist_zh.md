...
| Artifact integrity manifest CSV | True | 36536 | `outputs/agent_memory_artifact_integrity_manifest.csv` |
...
| Paper refresh coverage audit CSV | True | 8864 | `outputs/agent_memory_paper_refresh_coverage_audit.csv` |
