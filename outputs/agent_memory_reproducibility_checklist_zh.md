...
| Writer cost boundary report | True | 3073 | `outputs/agent_memory_writer_cost_boundary_zh.md` |
| Writer cost boundary CSV | True | 1420 | `outputs/agent_memory_writer_cost_boundary.csv` |
...
| Type3 intent-facet fusion report | True | 6275 | `outputs/agent_memory_type3_intent_fusion_zh.md` |
| Type3 intent-facet fusion summary | True | 2352 | `outputs/agent_memory_type3_intent_fusion_summary.csv` |
| Type3 intent-facet fusion deltas | True | 1093 | `outputs/agent_memory_type3_intent_fusion_deltas.csv` |
| Type3 intent-facet fusion facets | True | 41579 | `outputs/agent_memory_type3_intent_fusion_facets.csv` |
| Type3 rescue-space report | True | 2483 | `outputs/agent_memory_type3_rescue_space_zh.md` |
| Type3 rescue-space summary | True | 556 | `outputs/agent_memory_type3_rescue_space_summary.csv` |
| Type3 rescue-space classes | True | 605 | `outputs/agent_memory_type3_rescue_space_classes.csv` |
| Type3 supervised window report | True | 2198 | `outputs/agent_memory_type3_supervised_window_zh.md` |
| Type3 supervised window summary | True | 806 | `outputs/agent_memory_type3_supervised_window_summary.csv` |
| Type3 supervised window deltas | True | 280 | `outputs/agent_memory_type3_supervised_window_deltas.csv` |
| Type3 supervised window selected params | True | 435 | `outputs/agent_memory_type3_supervised_window_selected_params.csv` |
| Type3 supervised window feature importance | True | 1574 | `outputs/agent_memory_type3_supervised_window_feature_importance.csv` |
...
| Type3 learned expanded selector report | True | 2396 | `outputs/agent_memory_type3_learned_expanded_selector_zh.md` |
| Type3 learned expanded selector summary | True | 1472 | `outputs/agent_memory_type3_learned_expanded_selector_summary.csv` |
| Type3 learned expanded selector deltas | True | 391 | `outputs/agent_memory_type3_learned_expanded_selector_deltas.csv` |
| Type3 learned expanded selector selected params | True | 584 | `outputs/agent_memory_type3_learned_expanded_selector_selected_params.csv` |
| Type3 learned expanded selector weights | True | 2681 | `outputs/agent_memory_type3_learned_expanded_selector_weights.csv` |
| Type3 cluster coverage selector report | True | 1568 | `outputs/agent_memory_type3_cluster_coverage_selector_zh.md` |
| Type3 cluster coverage selector summary | True | 1548 | `outputs/agent_memory_type3_cluster_coverage_selector_summary.csv` |
| Type3 cluster coverage selector deltas | True | 508 | `outputs/agent_memory_type3_cluster_coverage_selector_deltas.csv` |
...
| Paper evidence matrix | True | 11836 | `outputs/agent_memory_paper_evidence_matrix_zh.md` |
...
| Supplementary package manifest CSV | True | 8553 | `outputs/agent_memory_supplementary_package_manifest.csv` |
...
| Untracked artifact audit | True | 11569 | `outputs/agent_memory_untracked_artifact_audit_zh.md` |
| Untracked artifact audit CSV | True | 10140 | `outputs/agent_memory_untracked_artifact_audit.csv` |
...
| Artifact integrity manifest CSV | True | 41343 | `outputs/agent_memory_artifact_integrity_manifest.csv` |
...
| Paper artifact refresh run | True | 8199 | `outputs/agent_memory_paper_artifact_refresh_run_zh.md` |
| Paper artifact refresh run CSV | True | 31915 | `outputs/agent_memory_paper_artifact_refresh_run.csv` |
| Paper refresh coverage audit | True | 11659 | `outputs/agent_memory_paper_refresh_coverage_audit_zh.md` |
| Paper refresh coverage audit CSV | True | 10465 | `outputs/agent_memory_paper_refresh_coverage_audit.csv` |
...
| API embedding paper acceptance gate | True | 1961 | `outputs/agent_memory_api_embedding_paper_acceptance_zh.md` |
| API embedding paper acceptance gate CSV | True | 1269 | `outputs/agent_memory_api_embedding_paper_acceptance.csv` |
...
| External embedding blocker audit | True | 3963 | `outputs/agent_memory_external_embedding_blocker_audit_zh.md` |
| External embedding blocker audit CSV | True | 1715 | `outputs/agent_memory_external_embedding_blocker_audit.csv` |
| Embedding paper-claim upgrade gate | True | 2526 | `outputs/agent_memory_embedding_paper_claim_upgrade_zh.md` |
| Embedding paper-claim upgrade gate CSV | True | 2576 | `outputs/agent_memory_embedding_paper_claim_upgrade.csv` |
...
| Writer cost boundary | `work/agent_memory_experiment/generate_writer_cost_boundary.py` | Separates one-time LLM memory-write tokens from reusable retrieval-time storage-token savings. |
...
| Type3 intent-facet fusion reranker | `work/agent_memory_experiment/type3_intent_fusion_reranker.py` | Tests conservative intent-facet Top-5 window reranking for Type3 queries without changing Top-5 evidence membership. |
...
| Type3 learned expanded-pool selector | `work/agent_memory_experiment/type3_learned_expanded_selector.py` | Tests a dependency-free learned selector on expanded Type3 pools with train/validation/test separation and records whether simple learned scoring can close the oracle gap. |
| Type3 cluster coverage selector | `work/agent_memory_experiment/type3_cluster_coverage_selector.py` | Tests whether unsupervised cluster diversity in the expanded pool improves or harms Top-5 gold evidence coverage. |
...
| API embedding paper acceptance gate | `work/agent_memory_experiment/validate_api_embedding_paper_acceptance.py` | Strictly checks query count, metric ranges, per-query rows, Top-20 ranking coverage, type coverage, and completed comparison deltas before paper citation. |
...
| Submission closure consistency audit | `work/agent_memory_experiment/validate_submission_closure_consistency.py` | Checks closure plan, final checklist, submission readiness, reviewer prep, and API acceptance for consistent blocker standards. |
