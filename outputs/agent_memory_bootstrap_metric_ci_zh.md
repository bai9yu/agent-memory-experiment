...
- `validation_tuned_router`：MRR delta=-0.0012，95% CI=[-0.0022, -0.0004]，CI 不跨 0，但方向为下降，应作为负结果表述。
- `text_intent_router`：MRR delta=-0.0146，95% CI=[-0.0205, -0.0088]，CI 不跨 0，但方向为下降，应作为负结果表述。
- `type3_query_decomposition_fusion4`：MRR delta=-0.0867，95% CI=[-0.1359, -0.0435]，CI 不跨 0，但方向为下降，应作为负结果表述。
...
| validation_tuned_router | mrr | 0.6067 [0.5914, 0.6219] | 0.6056 [0.5907, 0.6206] | -0.0012 [-0.0022, -0.0004] | 11/18/2731 |
| validation_tuned_router | recall@1 | 0.4989 [0.4804, 0.5174] | 0.4975 [0.4797, 0.5159] | -0.0014 [-0.0029, -0.0004] | 0/4/2756 |
| validation_tuned_router | recall@3 | 0.6696 [0.6522, 0.6877] | 0.6688 [0.6514, 0.6862] | -0.0007 [-0.0022, 0.0007] | 1/3/2756 |
| validation_tuned_router | recall@5 | 0.7333 [0.7170, 0.7500] | 0.7326 [0.7170, 0.7493] | -0.0007 [-0.0018, 0.0000] | 0/2/2758 |
| text_intent_router | mrr | 0.6094 [0.5902, 0.6288] | 0.5948 [0.5756, 0.6139] | -0.0146 [-0.0205, -0.0088] | 66/151/1621 |
| text_intent_router | recall@1 | 0.5033 [0.4804, 0.5261] | 0.4886 [0.4663, 0.5120] | -0.0147 [-0.0229, -0.0065] | 15/42/1781 |
| text_intent_router | recall@3 | 0.6703 [0.6496, 0.6921] | 0.6605 [0.6382, 0.6817] | -0.0098 [-0.0180, -0.0016] | 22/40/1776 |
| text_intent_router | recall@5 | 0.7334 [0.7133, 0.7535] | 0.7155 [0.6953, 0.7356] | -0.0180 [-0.0261, -0.0098] | 15/48/1775 |
| type3_query_decomposition_fusion4 | mrr | 0.4291 [0.3408, 0.5197] | 0.3424 [0.2647, 0.4187] | -0.0867 [-0.1359, -0.0435] | 17/40/29 |
| type3_query_decomposition_fusion4 | recall@1 | 0.3256 [0.2326, 0.4302] | 0.1977 [0.1163, 0.2907] | -0.1279 [-0.1977, -0.0581] | 0/11/75 |
