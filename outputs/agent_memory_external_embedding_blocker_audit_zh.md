...
| external_summary_completed | blocker | completed external embedding baselines=0, postrun_pass=0, paper_acceptance_pass=0 | Run memory_eval.py with semantic-backend api and generate summary.csv. | external_embedding_completed |
