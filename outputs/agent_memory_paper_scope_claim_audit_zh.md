...
| document_presence | document_exists | outputs/agent_memory_reproducibility_checklist_zh.md | info | True | chars=42382 | Document is available for scope-claim audit. |
