...
| document_presence | document_exists | outputs/agent_memory_reproducibility_checklist_zh.md | info | True | chars=37257 | Document is available for scope-claim audit. |
