...
| document_presence | document_exists | outputs/agent_memory_manuscript_draft_zh.md | info | True | chars=8492 | Document is available for scope-claim audit. |
...
| document_presence | document_exists | outputs/agent_memory_submission_gap_analysis_zh.md | info | True | chars=7580 | Document is available for scope-claim audit. |
...
| document_presence | document_exists | outputs/agent_memory_reproducibility_checklist_zh.md | info | True | chars=41894 | Document is available for scope-claim audit. |
