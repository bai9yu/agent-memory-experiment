...
| submission_package_consistency | pass | 0 | 0.023 | Checks package index coverage across supplement manifest, reproducibility list, and integrity manifest. |
...
| untracked_artifact_audit | pass | 0 | 0.046 | Classifies untracked local outputs before public artifact packaging. |
...
| artifact_path_portability | pass | 0 | 0.185 | Checks tracked paper-facing reports for machine-local absolute paths before artifact sharing. |
| public_release_readiness | pass | 0 | 0.446 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
