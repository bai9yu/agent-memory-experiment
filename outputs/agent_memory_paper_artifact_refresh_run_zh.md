...
| embedding_provider_profiles | pass | 0 | 0.034 | Refreshes provider-specific preflight, estimate, run, and compare commands. |
| api_embedding_preflight | pass | 0 | 0.045 | Refreshes paid/API embedding preflight without network calls. |
...
| public_release_readiness | pass | 0 | 0.436 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
...
| submission_entrypoint_consistency | pass | 0 | 0.022 | Checks that README/package/reproducibility entrypoints point to the current submission readiness artifact. |
