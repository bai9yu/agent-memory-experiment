...
| large_intermediate_provenance | pass | 0 | 0.135 | Audits large local ranked/per-query intermediates against README commands and tracked downstream summaries. |
| artifact_path_portability | pass | 0 | 0.176 | Checks tracked paper-facing reports for machine-local absolute paths before artifact sharing. |
| public_release_readiness | pass | 0 | 0.435 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
...
| artifact_integrity_manifest_final | pass | 0 | 0.042 | Final manifest refresh after freshness audit changes. |
