...
| api_embedding_preflight | pass | 0 | 0.035 | Refreshes paid/API embedding preflight without network calls. |
...
| public_release_readiness | pass | 0 | 0.423 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
| reproducibility_checklist | pass | 0 | 0.045 | Refreshes artifact and metric gates. |
| artifact_integrity_manifest | pass | 0 | 0.041 | Refreshes artifact sha256/size/line-count manifest. |
...
| artifact_integrity_manifest_final | pass | 0 | 0.040 | Final manifest refresh after freshness audit changes. |
