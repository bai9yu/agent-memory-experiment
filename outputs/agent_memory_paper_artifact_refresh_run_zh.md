...
| --- | --- | --- | --- | --- |
| offline_embedding_sensitivity | pass | 0 | 0.029 | Refreshes offline hash/BM25 vs BGE-M3 encoder-sensitivity diagnostics. |
| human_audit_execution_plan | pass | 0 | 0.032 | Refreshes the human-audit labeling execution plan from current gates. |
...
| untracked_artifact_audit | pass | 0 | 0.036 | Classifies untracked local outputs before public artifact packaging. |
