...
| human_audit_annotation_interface | pass | 0 | 0.023 | Generates offline HTML annotation interfaces for priority20/full80 blind-review sheets. |
...
| embedding_paper_claim_upgrade | pass | 0 | 0.023 | Checks which paper-facing embedding-baseline claim tier is currently unlocked. |
...
| public_release_readiness | pass | 0 | 0.432 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
| reproducibility_checklist | pass | 0 | 0.047 | Refreshes artifact and metric gates. |
| artifact_integrity_manifest | pass | 0 | 0.043 | Refreshes artifact sha256/size/line-count manifest. |
...
| manuscript_numeric_claim_check | pass | 0 | 0.031 | Checks that key numeric manuscript claims match current paper artifacts. |
