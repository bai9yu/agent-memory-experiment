...
| human_audit_labeling_dashboard | pass | 0 | 0.023 | Refreshes per-row human-audit labeling progress and next-item dashboard. |
...
| untracked_artifact_audit | pass | 0 | 0.033 | Classifies untracked local outputs before public artifact packaging. |
...
| artifact_path_portability | pass | 0 | 0.181 | Checks tracked paper-facing reports for machine-local absolute paths before artifact sharing. |
| public_release_readiness | pass | 0 | 0.431 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
...
| paper_manuscript | pass | 0 | 0.027 | Refreshes Chinese manuscript draft from current evidence. |
