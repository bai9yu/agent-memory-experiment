...
| supplementary_package_manifest | pass | 0 | 0.027 | Builds a supplement packaging manifest with blocker and anonymization checks. |
| anonymous_submission_readiness | pass | 0 | 0.024 | Checks anonymous-submission readiness for current supplement candidates. |
| paper_table_consistency | pass | 0 | 0.050 | Checks that paper Markdown/LaTeX tables are byte-identical to regenerated CSV-derived outputs. |
...
| artifact_path_portability | pass | 0 | 0.179 | Checks tracked paper-facing reports for machine-local absolute paths before artifact sharing. |
