...
| external_embedding_blocker_audit | pass | 0 | 0.023 | Refreshes actionable blocker audit for external embedding baselines. |
...
| large_intermediate_provenance | pass | 0 | 0.140 | Audits large local ranked/per-query intermediates against README commands and tracked downstream summaries. |
| artifact_path_portability | pass | 0 | 0.182 | Checks tracked paper-facing reports for machine-local absolute paths before artifact sharing. |
| public_release_readiness | pass | 0 | 0.427 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
