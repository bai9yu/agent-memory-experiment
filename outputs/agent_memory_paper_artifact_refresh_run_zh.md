...
| embedding_provider_profiles | pass | 0 | 0.022 | Refreshes provider-specific preflight, estimate, run, and compare commands. |
| api_embedding_preflight | pass | 0 | 0.036 | Refreshes paid/API embedding preflight without network calls. |
| api_embedding_run_estimate | pass | 0 | 0.035 | Refreshes API embedding item/token/batch estimate without network calls. |
...
| public_release_readiness | pass | 0 | 0.425 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
...
| artifact_integrity_manifest_final | pass | 0 | 0.041 | Final manifest refresh after freshness audit changes. |
