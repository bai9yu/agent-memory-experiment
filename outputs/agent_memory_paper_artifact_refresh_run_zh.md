...
| human_audit_protocol_compliance | pass | 0 | 0.023 | Checks that human-audit samples, schemas, codebook, interfaces, import checks, and claim gates form a protocol-ready package. |
...
| artifact_path_portability | pass | 0 | 0.177 | Checks tracked paper-facing reports for machine-local absolute paths before artifact sharing. |
| public_release_readiness | pass | 0 | 0.441 | Refreshes tracked-file release hygiene checks after untracked artifact audit. |
