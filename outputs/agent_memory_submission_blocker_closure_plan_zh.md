...
| 2 | external_embedding_completed | completed external embedding baselines=0 | Run memory_eval.py with semantic-backend api and generate summary.csv. | external embedding summary.csv exists and compare_embedding_baselines.py reports numeric deltas vs BGE-M3. | External embedding baseline can be added to the embedding comparison table. |
