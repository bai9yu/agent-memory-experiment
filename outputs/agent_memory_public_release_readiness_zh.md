...
| untracked_artifact_audit_present | paper_artifact | major | True | pass | untracked audit rows=13, review_before_tracking=0, keep_untracked=13 |
| artifact_paths_portable | paper_artifact | major | True | pass | path portability rows=1, findings=0 |
