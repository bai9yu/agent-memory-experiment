...
| outputs/agent_memory_type3_cluster_coverage_selector_per_query.csv | large_type3_coverage_intermediate | keep_untracked | 79140 | Detailed Type3 coverage-aware intermediate; tracked summary/delta/report carry paper-facing evidence. |
| outputs/agent_memory_type3_cluster_coverage_selector_ranked_top20.csv | large_type3_coverage_intermediate | keep_untracked | 8004426 | Detailed Type3 coverage-aware intermediate; tracked summary/delta/report carry paper-facing evidence. |
...
| outputs/agent_memory_type3_cluster_coverage_selector_deltas.csv | release_audit_artifact | track_as_paper_artifact | 508 | New public-release audit support file; track with the paper artifact package. |
| outputs/agent_memory_type3_cluster_coverage_selector_summary.csv | release_audit_artifact | track_as_paper_artifact | 1548 | New public-release audit support file; track with the paper artifact package. |
| outputs/agent_memory_type3_cluster_coverage_selector_zh.md | release_audit_artifact | track_as_paper_artifact | 1568 | New public-release audit support file; track with the paper artifact package. |
| work/agent_memory_experiment/type3_cluster_coverage_selector.py | release_audit_artifact | track_as_paper_artifact | 15846 | New public-release audit support file; track with the paper artifact package. |
