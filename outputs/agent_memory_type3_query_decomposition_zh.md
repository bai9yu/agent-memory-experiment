...
配对显著性检验显示，`type_aware_plus_decomposition` 相比 `type_aware` 的 MRR delta 为 `-0.0867`，95% CI `[-0.1376, -0.0442]`，permutation p-value `0.0002`；Recall@5 delta 为 `-0.0349`，p-value `0.3789`。因此当前关键词式 query decomposition 不能作为有效改进，只能作为弱基线和负结果。
...
| Which US state do Audrey and Andrew potentially live in? | Which US state do Audrey and Andrew potentially live in? // andrew audrey state audrey andrew potentially live // andrew audrey state audrey // andrew audrey andrew potentially live // andrew audrey audrey andrew // andrew audrey andrew potentially // andrew audrey potentially live // andrew audrey state audrey andrew // andrew audrey audrey andrew potentially // andrew audrey state audrey andrew potentially // andrew audrey audrey andrew potentially live // andrew audrey state | 1 | 1.000 |
