...
def build_rows(root: Path) -> list[dict[str, Any]]:
    ...
    rows = [
        ...
        },
        {
            ...
            "evidence": "BGE-M3 type-aware improves over hash and BM25 offline floors",
            "next_action": "保留为下界诊断；投稿前仍需真实外部 API embedding baseline。",
        },
        {
            "section": "Human Audit",
        ...
        {
            "section": "Reproducibility",
            "artifact": "outputs/agent_memory_environment_freshness_audit_zh.md",
            "role": "环境快照的 generation-time Git 状态和 system CSV 新鲜度审计。",
            "status": "pass",
            "evidence": "required failures=0",
            "next_action": "提交前后若刷新环境快照，应重新运行 freshness audit。",
        },
        {
            "section": "Reproducibility",
        ...
        {
            "section": "Reproducibility",
            "artifact": "outputs/agent_memory_paper_artifact_refresh_run_zh.md",
            "role": "离线论文 artifact 刷新流水线的逐步执行日志。",
            "status": "pass",
            "evidence": "refresh pipeline failures=0",
        ...
        },
        {
            ...
            "status": "ready_with_external_inputs",
            "evidence": blocker_evidence,
            "next_action": "按路线先解除 external embedding 和 human audit blockers。",
        },
        {
            "section": "Submission Gate",
