...
def build_steps(include_environment: bool) -> list[Step]:
    steps = [
        ...
        Step(
            "type3_learned_expanded_selector",
            py(
                "type3_learned_expanded_selector.py",
                "--candidate-ranked",
                "outputs/agent_memory_candidate_reranker_locomo10_ranked_top20.csv",
                "--queries",
                "work/agent_memory_experiment/data/llm_extracted_locomo10_all_v3_answerable_queries.jsonl",
            ...
            "Tests dependency-free learned selection over expanded Type3 candidate pools with train/validation/test separation.",
        ),
        Step(
            "type3_cluster_coverage_selector",
            py(
                "type3_cluster_coverage_selector.py",
                "--candidate-ranked",
                "outputs/agent_memory_candidate_reranker_locomo10_ranked_top20.csv",
                "--queries",
                "work/agent_memory_experiment/data/llm_extracted_locomo10_all_v3_answerable_queries.jsonl",
            ...
            "Tests whether unsupervised cluster diversity over expanded Type3 pools aligns with gold evidence coverage.",
        ),
        Step(
