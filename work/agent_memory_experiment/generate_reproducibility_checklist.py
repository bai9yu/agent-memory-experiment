...
def main() -> None:
    ...
    artifact_specs = [
        ...
        ("Type-aware error analysis report", outputs / "agent_memory_error_analysis_locomo10_type_aware_zh.md"),
        ("Type-aware error analysis CSV", outputs / "agent_memory_error_analysis_locomo10_type_aware.csv"),
        ("Type-aware error analysis summary", outputs / "agent_memory_error_analysis_locomo10_type_aware_summary.csv"),
        ...
        ("Paper manuscript numeric claim check", outputs / "agent_memory_manuscript_numeric_claim_check_zh.md"),
        ("Paper manuscript numeric claim check CSV", outputs / "agent_memory_manuscript_numeric_claim_check.csv"),
        ...
        ("Human audit priority20 annotation HTML", outputs / "agent_memory_human_audit_priority20_annotation.html"),
        ("Human audit full80 annotation HTML", outputs / "agent_memory_human_audit_full80_annotation.html"),
        ("Human audit annotation interface", outputs / "agent_memory_human_audit_annotation_interface_zh.md"),
        ...
        ("Human audit paper-claim upgrade gate", outputs / "agent_memory_human_audit_paper_claim_upgrade_zh.md"),
        ("Human audit paper-claim upgrade gate CSV", outputs / "agent_memory_human_audit_paper_claim_upgrade.csv"),
    ...
    command_rows = [
        ...
        {
            "stage": "Human audit annotation interface",
            "command": "work/agent_memory_experiment/generate_human_audit_annotation_interface.py",
            "notes": "Generates offline HTML annotation forms for priority20/full80 blind-review sheets with CSV export.",
        },
        {
        ...
        {
            "stage": "Human audit paper-claim upgrade gate",
            "command": "work/agent_memory_experiment/validate_human_audit_paper_claim_upgrade.py",
            "notes": "Maps current human-audit evidence to protocol-only, quick-review, full-review, and human-verified paper claim tiers.",
        },
        {
        ...
        {
            "stage": "Paper manuscript numeric claim check",
            "command": "work/agent_memory_experiment/validate_manuscript_numeric_claims.py",
            "notes": "Checks that key manuscript numbers match current paper tables and statistical artifacts.",
        },
        {
        ...
        {
            "stage": "Reviewer response preparation matrix",
            "command": "work/agent_memory_experiment/generate_reviewer_response_prep.py",
            "notes": "Maps likely reviewer questions to current evidence, remaining gaps, and safe paper-writing boundaries.",
        },
        {
        ...
        },
        {
            ...
            "command": "work/agent_memory_experiment/validate_submission_entrypoint_consistency.py",
            "notes": "Checks that README, package index, and reproducibility entrypoints all point to the current submission readiness artifact.",
        },
        {
